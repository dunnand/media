  ...
  document.getElementById('app').innerHTML = `
    <div class="login-screen">
      <div class="login-card">
        ...
        <div class="login-hint">Use your @${ALLOWED_DOMAIN} or @students.${ALLOWED_DOMAIN} account</div>
      </div>
    </div>`;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  firebase.auth().onAuthStateChanged(user => {
    ...
    const allowed = email.endsWith('@' + ALLOWED_DOMAIN) || email.endsWith('@students.' + ALLOWED_DOMAIN) || ALLOWED_EMAILS.includes(email);
    if (!allowed) {

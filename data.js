...
const INDEPTH_BEATS = [
  {
    ...
    covers: ['AP Programs','Dual Credit','Graduation','NHS','Academic Awards','Counseling','Student Services','Spartan Ambassadors','Academic Teams (Spell Bowl, Quiz Bowl, Super Bowl)'],
  ...
  },
  {
    ...
    seasons: ['fall','winter','spring'],
    covers: ['Art Department','Art Club','Architecture Club','Fashion Club','Film Club','Spartana','Photojournalism Club'],
    contacts: [],
  },
  {
  ...
  },
  {
    ...
    contacts: ['Mrs. Dean','Mrs. Whitt'],
  },
  {
    id: 13, name: 'Health, Wellness & Inclusion', icon: '💛', color: '#db2777',
    seasons: ['fall','winter','spring'],
    covers: ['P.E. Department','HOSA','NOW','SODA','GSA','Minority Student Union','Brothers of Unity','Best Buddies','Unified Teams','Special Education','Psychology Club'],
    contacts: ['Mrs. Bartel','Ms. Connelly','Mrs. Radloff','Mr. Anderson'],
  },
  {
